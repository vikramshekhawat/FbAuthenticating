...
@Table(value = "facebook_daily_account_performance")
public class AccountPerformanceBean {
	...
	public AccountPerformanceBean(String reporting_starts, String reporting_ends, String account_name,
	...
	/*
	 * Result indicator #Cost per results #Website purchases #Total conversion
	 * value #website adds to basket #website checkouts initiated #website
	 * conversions #website leads #website content views
	 */
